...
<section class="bg-cover bg-center h-96 text-white flex items-center" style="background-image: url('{{ asset('images/cocina.png') }}');">
    <div class="container mx-auto text-center">
        ...
        <button id="toggleFormButton" class="mt-6 inline-block bg-[#FF6F61] text-white text-lg font-semibold py-3 px-6 rounded-lg hover:bg-[#FF8C7F] transition duration-300">
